 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__19387,right){
var map__19388 = p__19387;
var map__19388__$1 = cljs.core.__destructure_map(map__19388);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19388__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19388__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__19390 = temp__5804__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19390,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19390,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19390,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19394__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__19395 = u(y);
var map__19395__$1 = cljs.core.__destructure_map(map__19395);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19395__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
...
var G__19416__i = 0, G__19416__a = new Array(arguments.length -  2);
while (G__19416__i < G__19416__a.length) {G__19416__a[G__19416__i] = arguments[G__19416__i + 2]; ++G__19416__i;}
  more = new cljs.core.IndexedSeq(G__19416__a,0,null);
} 
...
var G__19418 = null;
if (arguments.length > 2) {
var G__19419__i = 0, G__19419__a = new Array(arguments.length -  2);
while (G__19419__i < G__19419__a.length) {G__19419__a[G__19419__i] = arguments[G__19419__i + 2]; ++G__19419__i;}
G__19418 = new cljs.core.IndexedSeq(G__19419__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__19418);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19397__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__19398 = u(y);
var map__19398__$1 = cljs.core.__destructure_map(map__19398);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19398__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
...
var more = null;
if (arguments.length > 2) {
var G__19421__i = 0, G__19421__a = new Array(arguments.length -  2);
while (G__19421__i < G__19421__a.length) {G__19421__a[G__19421__i] = arguments[G__19421__i + 2]; ++G__19421__i;}
  more = new cljs.core.IndexedSeq(G__19421__a,0,null);
} 
...
var G__19423 = null;
if (arguments.length > 2) {
var G__19424__i = 0, G__19424__a = new Array(arguments.length -  2);
while (G__19424__i < G__19424__a.length) {G__19424__a[G__19424__i] = arguments[G__19424__i + 2]; ++G__19424__i;}
G__19423 = new cljs.core.IndexedSeq(G__19424__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__19423);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19401__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__19402 = u(y);
var map__19402__$1 = cljs.core.__destructure_map(map__19402);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19402__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__19426__delegate = function (x,y,more){
...
var G__19426 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__19427__i = 0, G__19427__a = new Array(arguments.length -  2);
while (G__19427__i < G__19427__a.length) {G__19427__a[G__19427__i] = arguments[G__19427__i + 2]; ++G__19427__i;}
  more = new cljs.core.IndexedSeq(G__19427__a,0,null);
} 
return G__19426__delegate.call(this,x,y,more);};
...
return G__19426__delegate(x,y,more);
});
...
G__19429 = new cljs.core.IndexedSeq(G__19430__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__19429);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19403__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__19404 = u(y);
var map__19404__$1 = cljs.core.__destructure_map(map__19404);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19404__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
...
while (G__19435__i < G__19435__a.length) {G__19435__a[G__19435__i] = arguments[G__19435__i + 2]; ++G__19435__i;}
  more = new cljs.core.IndexedSeq(G__19435__a,0,null);
} 
...
G__19437 = new cljs.core.IndexedSeq(G__19438__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__19437);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
