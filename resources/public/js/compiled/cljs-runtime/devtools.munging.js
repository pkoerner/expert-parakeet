...
var o12428 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12428["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12429 = temp__5802__auto____$1;
return (o12429["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12153__auto__ = f;
return (o__12153__auto__["toString"]).call(o__12153__auto__);
} else {
return "";
}
...
try{var o__12153__auto___12955 = t;
(o__12153__auto___12955["cljs$lang$ctorPrWriter"]).call(o__12153__auto___12955,t,writer);
}catch (e12470){var __12956 = e12470;
}
...
var char_code = (function (){var o__12153__auto__ = (new String(char$));
return (o__12153__auto__["charCodeAt"]).call(o__12153__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12153__auto__ = String;
return (o__12153__auto__["fromCharCode"]).call(o__12153__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12523 = num_code;
switch (G__12523) {
case (1):
return (185);
...
var o__12153__auto__ = String;
return (o__12153__auto__["fromCharCode"]).call(o__12153__auto__,superscript_code);
});
/**
...
}catch (e12554){var _e__12190__auto__ = e12554;
return false;
}})())){
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12621){
var vec__12622 = p__12621;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12622,(0),null);
...
var G__12967 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12968 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12967;
remaining_tokens = G__12968;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12609){
var G__12610 = cljs.core.first(seq12609);
var seq12609__$1 = cljs.core.next(seq12609);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12610,seq12609__$1);
}));
...
var vec__12654 = cljs.core.split_with((function (p1__12652_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12652_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12654,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12654,(1),null);
...
var vec__12698 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12698,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12698,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12970 = cljs.core.rest(remaining_tokens);
var G__12971 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12970;
name_tokens = G__12971;
continue;
} else {
...
var vec__12718 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12718,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12718,(1),null);
var vec__12721 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12721,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12721,(1),null);
var vec__12724 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12724,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12724,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12724,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12724,(3),null);
...
var vec__12744 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12744,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12744,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12744,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12744,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12744,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12744,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12757 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12757,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12757,(1),null);
var vec__12763 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12763,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12763,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12778 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12778) : devtools.munging.parse_fn_info_deep.call(null,G__12778));
})()));
}
} else {
return fn_info;
...
var G__12995 = (arity + (1));
var G__12996 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12791){
var vec__12792 = p__12791;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12792,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12792,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12817_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12817_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12818_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12818_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___12998 = arguments.length;
var i__5770__auto___12999 = (0);
while(true){
if((i__5770__auto___12999 < len__5769__auto___12998)){
args__5775__auto__.push((arguments[i__5770__auto___12999]));

var G__13000 = (i__5770__auto___12999 + (1));
i__5770__auto___12999 = G__13000;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12867){
var vec__12868 = p__12867;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12868,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12851){
var G__12852 = cljs.core.first(seq12851);
var seq12851__$1 = cljs.core.next(seq12851);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12852,seq12851__$1);
}));
...
var map__12896 = options;
var map__12896__$1 = cljs.core.__destructure_map(map__12896);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12896__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12896__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12896__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12896__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12897 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12897,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12897,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12897,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12897,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12897,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12897,(5),null);
...
var o__12153__auto__ = f;
return (o__12153__auto__["getBasis"]).call(o__12153__auto__);
});
/**
...
}catch (e12909){var _e__12190__auto__ = e12909;
...
var G__13023 = (obj[cljs.core.first(path)]);
var G__13024 = cljs.core.rest(path);
obj = G__13023;
path = G__13024;
continue;
} else {
...
var _STAR_ = (function (accum,p__12922){
var vec__12924 = p__12922;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12924,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12924,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12934){
var vec__12935 = p__12934;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12935,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12935,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12935,(2),null);
...
var post_process = (function (p__12949){
var vec__12950 = p__12949;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12950,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12950,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12943_SHARP_){
return (obj[cljs.core.first(p1__12943_SHARP_)]);
}),sorted_matches);
