...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k22640,else__5346__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__22709){
var vec__22710 = p__22709;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22710,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22710,(1),null);
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__22639){
var self__ = this;
var G__22639__$1 = this;
return (new cljs.core.RecordIter((0),G__22639__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"base","base",185279322)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this22644,other22645){
var self__ = this;
var this22644__$1 = this;
return (((!((other22645 == null)))) && ((((this22644__$1.constructor === other22645.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this22644__$1.value,other22645.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this22644__$1.base,other22645.base)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this22644__$1.__extmap,other22645.__extmap)))))))));
}));
...
var abs_value = (function (){var G__22750 = self__.value;
if((self__.value < (0))){
return (- G__22750);
} else {
return G__22750;
...
var prefix = (function (){var G__22752 = cljs.core.long$(self__.base);
switch (G__22752) {
case (8):
return "0";
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k22640){
var self__ = this;
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__22639){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__22764 = cljs.core.keyword_identical_QMARK_;
var expr__22765 = k__5352__auto__;
if(cljs.core.truth_((pred__22764.cljs$core$IFn$_invoke$arity$2 ? pred__22764.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__22765) : pred__22764.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__22765)))){
return (new rewrite_clj.node.integer.IntNode(G__22639,self__.base,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__22764.cljs$core$IFn$_invoke$arity$2 ? pred__22764.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"base","base",185279322),expr__22765) : pred__22764.call(null,new cljs.core.Keyword(null,"base","base",185279322),expr__22765)))){
return (new rewrite_clj.node.integer.IntNode(self__.value,G__22639,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__22639),null));
}
}
}));
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__22639){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,G__22639,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.integer.map__GT_IntNode = (function rewrite_clj$node$integer$map__GT_IntNode(G__22655){
var extmap__5385__auto__ = (function (){var G__22801 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__22655,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"base","base",185279322)], 0));
...
return (new rewrite_clj.node.integer.IntNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__22655),new cljs.core.Keyword(null,"base","base",185279322).cljs$core$IFn$_invoke$arity$1(G__22655),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
