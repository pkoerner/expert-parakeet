...
var arg_count_28249 = (cljs.core.count(expr) - (1));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((2),arg_count_28249)){
} else {
sci.impl.utils.throw_error_with_location.cljs$core$IFn$_invoke$arity$2(["Wrong number of args (",cljs.core.str.cljs$core$IFn$_invoke$arity$1(arg_count_28249),") passed to: clojure.core/for"].join(''),expr);
}
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (groups,p__27922){
var vec__27925 = p__27922;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27925,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27925,(1),null);
...
var err = (function() { 
var G__28254__delegate = function (msg){
...
while (G__28255__i < G__28255__a.length) {G__28255__a[G__28255__i] = arguments[G__28255__i + 0]; ++G__28255__i;}
  msg = new cljs.core.IndexedSeq(G__28255__a,0,null);
} 
return G__28254__delegate.call(this,msg);};
G__28254.cljs$lang$maxFixedArity = 0;
G__28254.cljs$lang$applyTo = (function (arglist__28256){
var msg = cljs.core.seq(arglist__28256);
return G__28254__delegate(msg);
});
G__28254.cljs$core$IFn$_invoke$arity$variadic = G__28254__delegate;
return G__28254;
})()
;
var emit_bind = (function sci$impl$for_macro$expand_for_$_emit_bind(p__27955){
var vec__27960 = p__27955;
var seq__27961 = cljs.core.seq(vec__27960);
var first__27962 = cljs.core.first(seq__27961);
var seq__27961__$1 = cljs.core.next(seq__27961);
var vec__27963 = first__27962;
var seq__27964 = cljs.core.seq(vec__27963);
var first__27965 = cljs.core.first(seq__27964);
var seq__27964__$1 = cljs.core.next(seq__27964);
var bind = first__27965;
var first__27965__$1 = cljs.core.first(seq__27964__$1);
var seq__27964__$2 = cljs.core.next(seq__27964__$1);
var expr__$1 = first__27965__$1;
var mod_pairs = seq__27964__$2;
var vec__27966 = seq__27961__$1;
var vec__27969 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27966,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27969,(0),null);
var next_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27969,(1),null);
var next_groups = vec__27966;
...
var do_mod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_mod(p__27976){
var vec__27978 = p__27976;
var seq__27979 = cljs.core.seq(vec__27978);
var first__27980 = cljs.core.first(seq__27979);
var seq__27979__$1 = cljs.core.next(seq__27979);
var vec__27981 = first__27980;
...
if(next_groups){
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","let","cljs.core/let",-308701135,null),null,(1),null)),(new cljs.core.List(null,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__27857__auto__","iterys__27857__auto__",548571867,null),null,(1),null)),(new cljs.core.List(null,sci$impl$for_macro$expand_for_$_emit_bind(next_groups),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__27859__auto__","fs__27859__auto__",31421949,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","seq","cljs.core/seq",-1649497689,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__27857__auto__","iterys__27857__auto__",548571867,null),null,(1),null)),(new cljs.core.List(null,next_expr,null,(1),null))))),null,(1),null))))),null,(1),null))], 0))))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"if","if",1181717262,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__27859__auto__","fs__27859__auto__",31421949,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","concat","cljs.core/concat",-1133584918,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__27859__auto__","fs__27859__auto__",31421949,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,giter,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,sci.impl.utils.allowed_recur,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null))], 0))));
} else {
...
var do_cmod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_cmod(p__28094){
