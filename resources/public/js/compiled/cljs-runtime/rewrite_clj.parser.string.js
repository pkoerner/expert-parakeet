...
if((c === "\n")){
var G__23510 = escape_QMARK_;
var G__23511 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__23510;
lines = G__23511;
continue;
} else {
buf.append(c);

var G__23512 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__23513 = lines;
escape_QMARK_ = G__23512;
lines = G__23513;
continue;
