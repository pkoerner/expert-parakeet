...
var G__25562 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(zloc_n0) : f.call(null,zloc_n0));
var G__25562__$1 = (((G__25562 == null))?null:cljs.core.iterate((function (loc){
...
var G__25562__$2 = (((G__25562__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__25562__$1));
var G__25562__$3 = (((G__25562__$2 == null))?null:cljs.core.last(G__25562__$2));
if((G__25562__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__25562__$3);
}
} else {
return zloc;
}
...
var G__25717 = rewrite_clj.zip.move.right(new_zloc_map_value);
var G__25718 = rewrite_clj.zip.move.up(new_zloc_map_value);
loc = G__25717;
parent = G__25718;
continue;
} else {
var G__25719 = rewrite_clj.zip.move.right(zloc_map_value);
var G__25720 = parent;
loc = G__25719;
parent = G__25720;
continue;
...
var G__25727 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(zloc_map_key));
var G__25728 = rewrite_clj.zip.move.up(zloc_map_key);
loc = G__25727;
parent = G__25728;
continue;
} else {
var G__25729 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__25730 = parent;
loc = G__25729;
parent = G__25730;
continue;
...
var G__25669 = zloc;
var G__25669__$1 = (((G__25669 == null))?null:rewrite_clj.zip.move.down(G__25669));
var G__25669__$2 = (((G__25669__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__25669__$1,k));
if((G__25669__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__25669__$2);
}
} else {
if(rewrite_clj.zip.seqz.namespaced_map_QMARK_(zloc)){
var G__25674 = zloc;
var G__25674__$1 = (((G__25674 == null))?null:rewrite_clj.zip.move.down(G__25674));
var G__25674__$2 = (((G__25674__$1 == null))?null:rewrite_clj.zip.move.rightmost(G__25674__$1));
var G__25674__$3 = (((G__25674__$2 == null))?null:rewrite_clj.zip.move.down(G__25674__$2));
var G__25674__$4 = (((G__25674__$3 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__25674__$3,k));
if((G__25674__$4 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__25674__$4);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__25678 = rewrite_clj.zip.move.down(zloc);
var G__25678__$1 = (((G__25678 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__25678));
if((G__25678__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__25678__$1);
}
})(),k);
