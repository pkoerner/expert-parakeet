...
var G__23872 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s__$1,(eol_ndx + cljs.core.count(m)));
var G__23873 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lines,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s__$1,(0),eol_ndx));
s__$1 = G__23872;
lines = G__23873;
continue;
} else {
...
var comma_23875 = rewrite_clj.node.whitespace.whitespace_nodes(", ");
var space_23876 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2(cljs.core.count(comma_23875),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__23852){
...
return cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$4(rewrite_clj.node.protocols.coerce(k),space_23876,rewrite_clj.node.protocols.coerce(v),comma_23875);
...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__23860 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
