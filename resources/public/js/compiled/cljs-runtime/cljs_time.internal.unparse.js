...
var periods__$1 = cljs.core.vec((function (){var G__51550 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51546_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__51546_SHARP_,(0),(3));
}),G__51550);
} else {
return G__51550;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__51569){
var vec__51570 = p__51569;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51570,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51570,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__51573 = pattern;
switch (G__51573) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51573)].join('')));
...
return p1__51578_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__51579_SHARP_){
return p1__51579_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__51580_SHARP_){
return p1__51580_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__51581_SHARP_){
return p1__51581_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__51582_SHARP_){
return p1__51582_SHARP_.getHours();
});

break;
case "day":
return (function (p1__51583_SHARP_){
return p1__51583_SHARP_.getDate();
});

break;
case "month":
return (function (p1__51584_SHARP_){
return p1__51584_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__51585_SHARP_){
return p1__51585_SHARP_.getYear();
});
...
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__51588){
...
var key = first__51591;
var args = seq__51590__$1;
var G__51592 = key;
...
var d = value;
var G__51600 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__51601 = G__51600;
...
var unparser = first__51603;
var more = seq__51602__$1;
var s = "";
var d__$1 = d;
var G__51600__$1 = G__51600;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__51611 = G__51600__$1;
var seq__51612 = cljs.core.seq(vec__51611);
var first__51613 = cljs.core.first(seq__51612);
var seq__51612__$1 = cljs.core.next(seq__51612);
var unparser__$1 = first__51613;
var more__$1 = seq__51612__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__51615 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51615,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51615,(1),null);
var G__51646 = d__$3;
var G__51647 = more__$1;
var G__51648 = s__$3;
d__$1 = G__51646;
G__51600__$1 = G__51647;
s__$1 = G__51648;
continue;
}
break;
