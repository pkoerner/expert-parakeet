...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__22252_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__22252_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__22252_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__22261){
var vec__22264 = p__22261;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22264,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22264,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__22275,s,color,element,idx){
var map__22276 = p__22275;
var map__22276__$1 = cljs.core.__destructure_map(map__22276);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22276__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22276__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22276__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__22287 = (function (){var or__5045__auto__ = color;
...
var fexpr__22286 = (function (){var G__22290 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__22290) : style_map.call(null,G__22290));
})();
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__22293){
var vec__22294 = p__22293;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22294,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22294,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22294,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__22299){
var vec__22300 = p__22299;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22300,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22300,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22300,(2),null);
...
var G__22551 = cljs.core.next(ssv);
var G__22552 = (this_ssv == null);
var G__22553 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__22554 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__22551;
doing_nil_QMARK_ = G__22552;
last_elide = G__22553;
out = G__22554;
continue;
}
...
var vec__22362 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22362,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22362,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22362,(2),null);
...
var G__22558 = cljs.core.next(remaining_cvec);
var G__22559 = new_idx;
var G__22560 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__22558;
idx = G__22559;
out = G__22560;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__22424,cursor_vec){
var vec__22425 = p__22424;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22425,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22425,(1),null);
var focus_vec = vec__22425;
...
var vec__22428 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22428,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22428,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__22435){
var vec__22436 = p__22435;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22436,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22436,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__22448,existing_count){
var vec__22450 = p__22448;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22450,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22450,(1),null);
...
return cljs.core.filterv((function (p1__22439_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__22439_SHARP_))));
...
var vec__22475 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22475,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22475,(1),null);
var cvec_element = vec__22475;
if((cvec_element == null)){
var G__22597 = cljs.core.next(cvec_nl);
var G__22598 = (idx + (1));
var G__22599 = start;
var G__22600 = out;
cvec_nl = G__22597;
...
var G__22604 = cljs.core.next(cvec_nl);
var G__22605 = (idx + (1));
var G__22606 = idx;
var G__22607 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__22604;
idx = G__22605;
start = G__22606;
out = G__22607;
...
var G__22610 = cljs.core.next(cvec_nl);
var G__22611 = (idx + (1));
var G__22612 = (idx + (1));
var G__22613 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__22610;
idx = G__22611;
start = G__22612;
out = G__22613;
...
var G__22615 = cljs.core.next(cvec_nl);
var G__22616 = (idx + (1));
var G__22617 = idx;
var G__22618 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__22615;
idx = G__22616;
start = G__22617;
out = G__22618;
...
var G__22620 = cljs.core.next(cvec_nl);
var G__22621 = (idx + (1));
var G__22622 = start;
var G__22623 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__22620;
idx = G__22621;
start = G__22622;
out = G__22623;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__22490_SHARP_,p2__22489_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__22489_SHARP_)){
return cljs.core.reduced(p1__22490_SHARP_);
} else {
return (p1__22490_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__22491,p__22492){
var vec__22493 = p__22491;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22493,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22493,(1),null);
var vec__22496 = p__22492;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22496,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22496,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__22509,cvec,focus_vec){
var map__22510 = p__22509;
var map__22510__$1 = cljs.core.__destructure_map(map__22510);
var options = map__22510__$1;
var map__22511 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22510__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__22511__$1 = cljs.core.__destructure_map(map__22511);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22511__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22511__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22511__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22506_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__22506_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
