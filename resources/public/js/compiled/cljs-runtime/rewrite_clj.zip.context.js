...
return rewrite_clj.zip.walk.postwalk.cljs$core$IFn$_invoke$arity$3(zloc,(function (p1__26260_SHARP_){
var G__26263 = rewrite_clj.custom_zipper.core.node(p1__26260_SHARP_);
if((!((G__26263 == null)))){
if(((false) || ((cljs.core.PROTOCOL_SENTINEL === G__26263.rewrite_clj$node$protocols$MapQualifiable$)))){
return true;
} else {
if((!G__26263.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_(rewrite_clj.node.protocols.MapQualifiable,G__26263);
} else {
return false;
}
}
