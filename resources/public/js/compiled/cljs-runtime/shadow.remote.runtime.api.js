...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_44696 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_44696(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_44700 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_44700(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_44704 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_44704(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_44709 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_44709(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_44711 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_44711(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_44726 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_44726(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__44682,callback){
var map__44684 = p__44682;
var map__44684__$1 = cljs.core.__destructure_map(map__44684);
var input = map__44684__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44684__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44684__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
