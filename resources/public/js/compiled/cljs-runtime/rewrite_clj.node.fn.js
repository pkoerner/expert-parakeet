...
var sym_seq = (function (){var iter__5523__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__23366(s__23367){
return (new cljs.core.LazySeq(null,(function (){
var s__23367__$1 = s__23367;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__23367__$1);
if(temp__5804__auto__){
var s__23367__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23367__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__23367__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__23369 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__23368 = (0);
while(true){
if((i__23368 < size__5522__auto__)){
var i = cljs.core._nth(c__5521__auto__,i__23368);
...
cljs.core.chunk_append(b__23369,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__23535 = (i__23368 + (1));
i__23368 = G__23535;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23369),rewrite_clj$node$fn$fn_walk_$_iter__23366(cljs.core.chunk_rest(s__23367__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23369),null);
}
} else {
var i = cljs.core.first(s__23367__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__23366(cljs.core.rest(s__23367__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__23353_SHARP_){
var or__5045__auto__ = rewrite_clj.node.fn.arg_symbol__GT_gensym(sym_seq,vararg_QMARK_,max_fixed_arg_ndx,p1__23353_SHARP_);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k23388,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k23388,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__23411){
var vec__23413 = p__23411;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23413,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23413,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__23387){
var self__ = this;
var G__23387__$1 = this;
return (new cljs.core.RecordIter((0),G__23387__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this23389,other23390){
var self__ = this;
var this23389__$1 = this;
return (((!((other23390 == null)))) && ((((this23389__$1.constructor === other23390.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23389__$1.children,other23390.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23389__$1.__extmap,other23390.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k23388){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k23388);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__23387){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__23475 = cljs.core.keyword_identical_QMARK_;
var expr__23476 = k__5352__auto__;
if(cljs.core.truth_((pred__23475.cljs$core$IFn$_invoke$arity$2 ? pred__23475.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__23476) : pred__23475.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__23476)))){
return (new rewrite_clj.node.fn.FnNode(G__23387,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__23387),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__23387){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__23387,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__23395){
var extmap__5385__auto__ = (function (){var G__23526 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__23395,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__23395)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__23526);
} else {
return G__23526;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__23395),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
