...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__23824 = cljs.core.get_global_hierarchy;
return (fexpr__23824.cljs$core$IFn$_invoke$arity$0 ? fexpr__23824.cljs$core$IFn$_invoke$arity$0() : fexpr__23824.call(null));
})());
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__23826_SHARP_){
var _STAR_delimiter_STAR__orig_val__23830 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__23831 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__23831);

try{return rewrite_clj.parser.core.parse_next(p1__23826_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__23830);
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__5775__auto__ = [];
var len__5769__auto___23861 = arguments.length;
var i__5770__auto___23862 = (0);
while(true){
if((i__5770__auto___23862 < len__5769__auto___23861)){
args__5775__auto__.push((arguments[i__5770__auto___23862]));

var G__23863 = (i__5770__auto___23862 + (1));
i__5770__auto___23862 = G__23863;
continue;
} else {
}
break;
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__23837){
var vec__23838 = p__23837;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23838,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq23833){
...
var G__23836 = cljs.core.first(seq23833__$2);
var seq23833__$3 = cljs.core.next(seq23833__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23834,G__23835,G__23836,seq23833__$3);
}));
...
var G__23851 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__23851)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__23851)){
...
return cljs.core.cons((function (){var G__23857 = rewrite_clj.reader.peek(reader);
switch (G__23857) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__23851)){
