...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__57541){
var map__57543 = p__57541;
var map__57543__$1 = cljs.core.__destructure_map(map__57543);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57543__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57543__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57544,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57544,(1),null);
...
var method_cache__5644__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5645__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__57551 = cljs.core.get_global_hierarchy;
...
var map__57552 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
var map__57552__$1 = cljs.core.__destructure_map(map__57552);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57552__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57552__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__57553){
var vec__57554 = p__57553;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57554,(0),null);
var map__57557 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57554,(1),null);
var map__57557__$1 = cljs.core.__destructure_map(map__57557);
var schema = map__57557__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57557__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__5644__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5645__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__57558 = cljs.core.get_global_hierarchy;
return (fexpr__57558.cljs$core$IFn$_invoke$arity$0 ? fexpr__57558.cljs$core$IFn$_invoke$arity$0() : fexpr__57558.call(null));
})());
...
})(),(function (){var iter__5523__auto__ = (function spec_tools$swagger$core$iter__57559(s__57560){
...
var vec__57578 = cljs.core._nth(c__5521__auto__,i__57561);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57578,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57578,(1),null);
cljs.core.chunk_append(b__57562,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57562),spec_tools$swagger$core$iter__57559(cljs.core.chunk_rest(s__57560__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57562),null);
}
} else {
var vec__57593 = cljs.core.first(s__57560__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57593,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57593,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__57559(cljs.core.rest(s__57560__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__57596){
var vec__57597 = p__57596;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57597,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57597,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__57601,p){
var vec__57602 = p__57601;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57602,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57602,(1),null);
var acc__$1 = vec__57602;
