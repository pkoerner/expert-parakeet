...
var G__16424 = (i__5770__auto___16419 + (1));
i__5770__auto___16419 = G__16424;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__15910_16428 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__15911_16429 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__15912_16430 = true;
var _STAR_print_fn_STAR__temp_val__15913_16431 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__15912_16430);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__15913_16431);

try{var _STAR_print_level_STAR__orig_val__15918_16432 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__15919_16433 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__15919_16433);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__15918_16432);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__15911_16429);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__15910_16428);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq15908){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq15908));
}));
...
var new_formatters = current_formatters.filter((function (p1__16086_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__16086_SHARP_)));
}));
...
var G__16111_16470 = f;
var target__12178__auto___16471 = G__16111_16470;
if(cljs.core.truth_(target__12178__auto___16471)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16111_16470)].join(''),"\n","target__12178__auto__"].join('')));
}

(target__12178__auto___16471["toString"] = (function (){
...
var G__16140_16473 = "%c%s";
var G__16141_16474 = "color:transparent";
var G__16142_16475 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__16140_16473,G__16141_16474,G__16142_16475) : f.call(null,G__16140_16473,G__16141_16474,G__16142_16475));
...
while(true){
if((i__5770__auto___16486 < len__5769__auto___16484)){
...
var vec__16212 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16212,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16212,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__16491__delegate = function (add_fmt,add_args){
...
var G__16491 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__16494__i = 0, G__16494__a = new Array(arguments.length -  1);
while (G__16494__i < G__16494__a.length) {G__16494__a[G__16494__i] = arguments[G__16494__i + 1]; ++G__16494__i;}
  add_args = new cljs.core.IndexedSeq(G__16494__a,0,null);
} 
return G__16491__delegate.call(this,add_fmt,add_args);};
G__16491.cljs$lang$maxFixedArity = 1;
G__16491.cljs$lang$applyTo = (function (arglist__16495){
var add_fmt = cljs.core.first(arglist__16495);
var add_args = cljs.core.rest(arglist__16495);
return G__16491__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq16188){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16189,G__16190,G__16191,seq16188__$3);
}));
...
var seq__16293 = cljs.core.seq(features);
var chunk__16294 = null;
var count__16295 = (0);
var i__16296 = (0);
while(true){
if((i__16296 < count__16295)){
var feature = chunk__16294.cljs$core$IIndexed$_nth$arity$2(null,i__16296);
...
var G__16503 = seq__16293;
var G__16504 = chunk__16294;
var G__16505 = count__16295;
var G__16506 = (i__16296 + (1));
seq__16293 = G__16503;
chunk__16294 = G__16504;
count__16295 = G__16505;
i__16296 = G__16506;
continue;
} else {
...
var c__5568__auto__ = cljs.core.chunk_first(seq__16293__$1);
var G__16510 = cljs.core.chunk_rest(seq__16293__$1);
var G__16511 = c__5568__auto__;
var G__16512 = cljs.core.count(c__5568__auto__);
var G__16513 = (0);
seq__16293 = G__16510;
chunk__16294 = G__16511;
count__16295 = G__16512;
i__16296 = G__16513;
continue;
} else {
var feature = cljs.core.first(seq__16293__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__16514 = cljs.core.next(seq__16293__$1);
var G__16515 = null;
var G__16516 = (0);
var G__16517 = (0);
seq__16293 = G__16514;
chunk__16294 = G__16515;
count__16295 = G__16516;
i__16296 = G__16517;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o16390 = temp__5802__auto__;
return (o16390["version"]);
} else {
return null;
}
})() == null);
