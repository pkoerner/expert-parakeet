...
sci.impl.interop.get_static_field = (function sci$impl$interop$get_static_field(p__27451){
var vec__27453 = p__27451;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27453,(0),null);
var field_name_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27453,(1),null);
...
var G__27467 = cljs.core.count(args__$1);
switch (G__27467) {
case (0):
return (new ctor());
...
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(p__27476,args){
var vec__27477 = p__27476;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27477,(0),null);
var method_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27477,(1),null);
...
sci.impl.interop.fully_qualify_class = (function sci$impl$interop$fully_qualify_class(p__27486,sym){
var map__27488 = p__27486;
var map__27488__$1 = cljs.core.__destructure_map(map__27488);
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27488__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var class__GT_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27488__$1,new cljs.core.Keyword(null,"class->opts","class->opts",2061906477));
...
sci.impl.interop.resolve_class_opts = (function sci$impl$interop$resolve_class_opts(p__27500,sym){
var map__27501 = p__27500;
var map__27501__$1 = cljs.core.__destructure_map(map__27501);
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27501__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var class__GT_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27501__$1,new cljs.core.Keyword(null,"class->opts","class->opts",2061906477));
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__27503 = temp__5802__auto__;
