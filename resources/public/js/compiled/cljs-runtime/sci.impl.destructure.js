...
var G__25622 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__25623 = n;
var G__25624 = cljs.core.nnext(bs);
var G__25625 = true;
ret = G__25622;
n = G__25623;
bs = G__25624;
seen_rest_QMARK_ = G__25625;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__25527_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__5045__auto__ = mkns;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return cljs.core.namespace(p1__25527_SHARP_);
}
})(),cljs.core.name(p1__25527_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__25528_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__5045__auto__ = mkns;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return cljs.core.namespace(p1__25528_SHARP_);
}
})(),cljs.core.name(p1__25528_SHARP_));
}));
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__25529_SHARP_,p2__25530_SHARP_,(function (){var fexpr__25573 = cljs.core.val(entry);
return (fexpr__25573.cljs$core$IFn$_invoke$arity$1 ? fexpr__25573.cljs$core$IFn$_invoke$arity$1(p2__25530_SHARP_) : fexpr__25573.call(null,p2__25530_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__25574 = cljs.core.key(entry);
return (fexpr__25574.cljs$core$IFn$_invoke$arity$1 ? fexpr__25574.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__25574.call(null,bes));
})());
...
var G__25657 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__25658 = cljs.core.next(bes);
ret = G__25657;
bes = G__25658;
continue;
} else {
...
var temp__5802__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__25534_SHARP_){
return (cljs.core.first(p1__25534_SHARP_) instanceof cljs.core.Keyword);
}),bents));
