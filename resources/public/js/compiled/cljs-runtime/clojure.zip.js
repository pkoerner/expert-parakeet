...
var G__22298 = clojure.zip.node(loc);
var fexpr__22297 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__22297.cljs$core$IFn$_invoke$arity$1 ? fexpr__22297.cljs$core$IFn$_invoke$arity$1(G__22298) : fexpr__22297.call(null,G__22298));
});
/**
...
var G__22304 = clojure.zip.node(loc);
var fexpr__22303 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__22303.cljs$core$IFn$_invoke$arity$1 ? fexpr__22303.cljs$core$IFn$_invoke$arity$1(G__22304) : fexpr__22303.call(null,G__22304));
} else {
...
var fexpr__22312 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__22312.cljs$core$IFn$_invoke$arity$2 ? fexpr__22312.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__22312.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__22318 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22318,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22318,(1),null);
var vec__22321 = clojure.zip.children(loc);
var seq__22322 = cljs.core.seq(vec__22321);
var first__22323 = cljs.core.first(seq__22322);
var seq__22322__$1 = cljs.core.next(seq__22322);
var c = first__22323;
var cnext = seq__22322__$1;
var cs = vec__22321;
...
var vec__22335 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22335,(0),null);
var map__22338 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22335,(1),null);
var map__22338__$1 = cljs.core.__destructure_map(map__22338);
var path = map__22338__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22338__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22338__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22338__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22338__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22338__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__22348 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22348,(0),null);
var map__22351 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22348,(1),null);
var map__22351__$1 = cljs.core.__destructure_map(map__22351);
var path = map__22351__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22351__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__22352 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22351__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__22365 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22365,(0),null);
var map__22368 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22365,(1),null);
var map__22368__$1 = cljs.core.__destructure_map(map__22368);
var path = map__22368__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22368__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22368__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return r;
} else {
...
var vec__22376 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22376,(0),null);
var map__22380 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22376,(1),null);
var map__22380__$1 = cljs.core.__destructure_map(map__22380);
var path = map__22380__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22380__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22380__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
...
var vec__22388 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22388,(0),null);
var map__22391 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22388,(1),null);
var map__22391__$1 = cljs.core.__destructure_map(map__22391);
var path = map__22391__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22391__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22391__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__22392 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22392,(0),null);
var map__22395 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22392,(1),null);
var map__22395__$1 = cljs.core.__destructure_map(map__22395);
var path = map__22395__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22395__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var map__22409 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22406,(1),null);
var map__22409__$1 = cljs.core.__destructure_map(map__22409);
var path = map__22409__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22409__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22410,(1),null);
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq22418){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22419,G__22420,seq22418__$2);
}));
...
var G__22508 = clojure.zip.rightmost(child);
loc__$1 = G__22508;
continue;
} else {
return loc__$1;
...
var vec__22457 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22457,(0),null);
var map__22460 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22457,(1),null);
var map__22460__$1 = cljs.core.__destructure_map(map__22460);
var path = map__22460__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22460__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22460__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22460__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22460__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__22512 = clojure.zip.rightmost(child);
loc__$1 = G__22512;
continue;
} else {
return loc__$1;
