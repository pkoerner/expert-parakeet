...
var rewrite_clj$node$protocols$Node$tag$dyn_22638 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_22638(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_22657 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_22657(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_22663 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_22663(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_22666 = (function (node,opts){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_22666(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_22681 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_22681(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_22683 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_22683(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22462_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__22462_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_22705 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_22705(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_22708 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_22708(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_22713 = (function (node,children){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_22713(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_22714 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_22714(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_22728 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_22728(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_22733 = (function (node,map_qualifier){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_22733(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_22741 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_22741(node);
}
});
...
var map__22578 = cljs.core.meta(node);
var map__22578__$1 = cljs.core.__destructure_map(map__22578);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22578__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22578__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22578__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22578__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__22585,p__22586){
var vec__22587 = p__22585;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22587,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22587,(1),null);
var vec__22590 = p__22586;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22590,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22590,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__22593 = col_extent;
if((row_extent === (0))){
return (G__22593 + col);
} else {
return G__22593;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__22624 = rewrite_clj.node.protocols.children(node);
var G__22624__$1 = (((G__22624 == null))?null:cljs.core.first(G__22624));
if((G__22624__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__22624__$1);
}
} else {
