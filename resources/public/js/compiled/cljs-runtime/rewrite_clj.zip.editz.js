...
return rewrite_clj.node.protocols.coerce((function (){var G__25481 = rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(node,opts);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__25481) : f.call(null,G__25481));
})());
});
});
/**
...
var len__5769__auto___25519 = arguments.length;
var i__5770__auto___25520 = (0);
while(true){
if((i__5770__auto___25520 < len__5769__auto___25519)){
args__5775__auto__.push((arguments[i__5770__auto___25520]));

var G__25525 = (i__5770__auto___25520 + (1));
i__5770__auto___25520 = G__25525;
continue;
} else {
}
break;
...
return rewrite_clj.custom_zipper.core.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.node_editor(rewrite_clj.zip.options.get_opts(zloc)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__25482_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__25482_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq25483){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25484,G__25485,seq25483__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__25492 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__25492) : str_fn.call(null,G__25492));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__25493 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__25493) : str_fn.call(null,G__25493));
})()):null)));
...
var G__25500 = rewrite_clj.zip.base.tag(zloc);
var G__25500__$1 = (((G__25500 instanceof cljs.core.Keyword))?G__25500.fqn:null);
switch (G__25500__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__25494_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__25494_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__25495_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__25495_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25500__$1)].join('')));
...
var G__25506 = rewrite_clj.zip.base.tag(zloc);
var G__25506__$1 = (((G__25506 instanceof cljs.core.Keyword))?G__25506.fqn:null);
switch (G__25506__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__25505_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__25505_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25506__$1)].join('')));
