...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k23287,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k23287,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__23357){
var vec__23362 = p__23357;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23362,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23362,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__23286){
var self__ = this;
var G__23286__$1 = this;
return (new cljs.core.RecordIter((0),G__23286__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this23288,other23289){
var self__ = this;
var this23288__$1 = this;
return (((!((other23289 == null)))) && ((((this23288__$1.constructor === other23289.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23288__$1.tag,other23289.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23288__$1.prefix,other23289.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23288__$1.sym,other23289.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23288__$1.children,other23289.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23288__$1.__extmap,other23289.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k23287){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k23287);

}
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__23286){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__23467 = cljs.core.keyword_identical_QMARK_;
var expr__23468 = k__5352__auto__;
if(cljs.core.truth_((pred__23467.cljs$core$IFn$_invoke$arity$2 ? pred__23467.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__23468) : pred__23467.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__23468)))){
return (new rewrite_clj.node.quote.QuoteNode(G__23286,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__23467.cljs$core$IFn$_invoke$arity$2 ? pred__23467.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__23468) : pred__23467.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__23468)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__23286,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__23467.cljs$core$IFn$_invoke$arity$2 ? pred__23467.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__23468) : pred__23467.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__23468)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__23286,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__23467.cljs$core$IFn$_invoke$arity$2 ? pred__23467.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__23468) : pred__23467.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__23468)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__23286,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__23286),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__23286){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__23286,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__23308){
var extmap__5385__auto__ = (function (){var G__23500 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__23308,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__23308)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__23500);
} else {
return G__23500;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__23308),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__23308),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__23308),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__23308),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
var G__23562 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__23562;
continue;
}
break;
...
var G__23565 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__23565;
continue;
}
break;
...
var G__23566 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__23566;
continue;
}
break;
...
var G__23568 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__23568;
continue;
}
break;
