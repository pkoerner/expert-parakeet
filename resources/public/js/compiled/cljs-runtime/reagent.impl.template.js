...
var G__19389 = o;
reagent.impl.template.goog$module$goog$object.set(G__19389,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__19456__i < G__19456__a.length) {G__19456__a[G__19456__i] = arguments[G__19456__i + 0]; ++G__19456__i;}
  args = new cljs.core.IndexedSeq(G__19456__a,0,null);
} 
return G__19455__delegate.call(this,args);};
G__19455.cljs$lang$maxFixedArity = 0;
G__19455.cljs$lang$applyTo = (function (arglist__19458){
...
var G__19393 = o;
reagent.impl.template.goog$module$goog$object.set(G__19393,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__19463__i < G__19463__a.length) {G__19463__a[G__19463__i] = arguments[G__19463__i + 0]; ++G__19463__i;}
  args = new cljs.core.IndexedSeq(G__19463__a,0,null);
} 
...
var G__19396 = props;
var G__19396__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__19396,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__19396);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__19396__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__19399 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__19399,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__19399;
}
})(),id_class);
...
var G__19400 = (cljs.core.count(argv) - first_child);
switch (G__19400) {
case (0):
...
var vec__19405 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19405,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19405,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19405,(2),null);
...
var temp__5808__auto___19469 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___19469 == null)){
} else {
var key_19470 = temp__5808__auto___19469;
(jsprops.key = key_19470);
}
...
var temp__5808__auto___19472 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___19472 == null)){
} else {
var key_19474 = temp__5808__auto___19472;
(jsprops.key = key_19474);
}
...
var temp__5808__auto___19477 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___19477 == null)){
} else {
var key_19478 = temp__5808__auto___19477;
(jsprops.key = key_19478);
}
...
var temp__5808__auto___19484 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___19484 == null)){
} else {
var key_19485 = temp__5808__auto___19484;
(jsprops.key = key_19485);
}
...
var temp__5808__auto___19490 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___19490 == null)){
} else {
var key_19491 = temp__5808__auto___19490;
(jsprops.key = key_19491);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19409_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__19409_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__19410 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19410,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19410,(1),null);
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template19431 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template19431 = (function (opts,id,fn_to_element,parse_fn,meta19432){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template19431.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19433,meta19432__$1){
var self__ = this;
var _19433__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template19431(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta19432__$1));
}));

(reagent.impl.template.t_reagent$impl$template19431.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19433){
var self__ = this;
var _19433__$1 = this;
return self__.meta19432;
}));

(reagent.impl.template.t_reagent$impl$template19431.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template19431.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template19431.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template19431.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template19431.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template19431.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta19432","meta19432",-818457952,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template19431.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template19431.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template19431");

(reagent.impl.template.t_reagent$impl$template19431.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template19431");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template19431.
 */
reagent.impl.template.__GT_t_reagent$impl$template19431 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template19431(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta19432){
return (new reagent.impl.template.t_reagent$impl$template19431(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta19432));
});

}

return (new reagent.impl.template.t_reagent$impl$template19431(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
