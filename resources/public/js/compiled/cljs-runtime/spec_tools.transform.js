...
if((x instanceof cljs.core.Keyword)){
var G__56289 = spec;
var G__56290 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__56289,G__56290) : f.call(null,G__56289,G__56290));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__56291 = spec;
var G__56292 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__56291,G__56292) : f.call(null,G__56291,G__56292));
} else {
return x;
...
if(typeof x === 'number'){
var G__56293 = spec;
var G__56294 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__56293,G__56294) : f.call(null,G__56293,G__56294));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
}catch (e56295){if((e56295 instanceof Error)){
var ___$1 = e56295;
return x;
} else {
throw e56295;
...
}catch (e56303){if((e56303 instanceof Error)){
var ___$1 = e56303;
return x;
} else {
throw e56303;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__56306,x){
var map__56307 = p__56306;
var map__56307__$1 = cljs.core.__destructure_map(map__56307);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56307__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__56316,x){
var map__56317 = p__56316;
var map__56317__$1 = cljs.core.__destructure_map(map__56317);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56317__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__56320,x){
var map__56321 = p__56320;
var map__56321__$1 = cljs.core.__destructure_map(map__56321);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56321__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
