...
var G__13063 = devtools.prefs.pref(v);
v = G__13063;
continue;
} else {
return v;
...
}catch (e12984){var _e__12190__auto__ = e12984;
return false;
}})();
...
}catch (e12991){var _e__12190__auto__ = e12991;
return false;
}})();
...
}catch (e12993){var _e__12190__auto__ = e12993;
return false;
}}
}
});
...
var vec__13015 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13015,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13015,(1),null);
...
return cljs.core.some((function (p1__13033_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13033_SHARP_);
}),template);
});
