...
var G__49080 = format;
var G__49080__$1 = (((G__49080 instanceof cljs.core.Keyword))?G__49080.fqn:null);
switch (G__49080__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__49087 = cljs.core.second(format);
var G__49088 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__49087,G__49088) : ajax.easy.keyword_response_format_element.call(null,G__49087,G__49088));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49095_SHARP_){
return ajax.easy.keyword_response_format_element(p1__49095_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__49116){
...
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49117__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49117__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__49119){
var vec__49120 = p__49119;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49120,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49120,(1),null);
var fexpr__49124_49153 = (cljs.core.truth_(ok)?h:e);
(fexpr__49124_49153.cljs$core$IFn$_invoke$arity$1 ? fexpr__49124_49153.cljs$core$IFn$_invoke$arity$1(result) : fexpr__49124_49153.call(null,result));
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__49126){
var map__49127 = p__49126;
var map__49127__$1 = cljs.core.__destructure_map(map__49127);
var opts = map__49127__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49127__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49127__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49127__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49127__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49127__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
