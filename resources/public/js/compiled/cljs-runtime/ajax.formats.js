...
var G__48952 = request;
var G__48953 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__48952,G__48953) : ajax.formats.get_format.call(null,G__48952,G__48953));
} else {
...
return cljs.core.some((function (p1__48955_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__48955_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__48960){
var map__48961 = p__48960;
var map__48961__$1 = cljs.core.__destructure_map(map__48961);
var request = map__48961__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48961__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__48962 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__48962.cljs$core$IFn$_invoke$arity$1 ? fexpr__48962.cljs$core$IFn$_invoke$arity$1(response) : fexpr__48962.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__48964){
var map__48965 = p__48964;
var map__48965__$1 = cljs.core.__destructure_map(map__48965);
var request = map__48965__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48965__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__48963_SHARP_){
return ajax.formats.get_accept_entries(request,p1__48963_SHARP_);
