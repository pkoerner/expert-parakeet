...
var vec__56038 = cljs.core.rest(expr);
var seq__56039 = cljs.core.seq(vec__56038);
var first__56040 = cljs.core.first(seq__56039);
var seq__56039__$1 = cljs.core.next(seq__56039);
var vec__56041 = first__56040;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56041,(0),null);
var form = seq__56039__$1;
...
var G__56044 = x;
var G__56044__$1 = (((G__56044 == null))?null:spec_tools.impl.polish(G__56044));
var G__56044__$2 = (((G__56044__$1 == null))?null:cljs.core.name(G__56044__$1));
if((G__56044__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__56044__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__56045 = x;
var G__56045__$1 = (((G__56045 == null))?null:cljs.core.name(G__56045));
if((G__56045__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__56045__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__56046){
var map__56047 = p__56046;
var map__56047__$1 = cljs.core.__destructure_map(map__56047);
var data = map__56047__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56047__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56047__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56047__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56047__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__56048){
var map__56049 = p__56048;
var map__56049__$1 = cljs.core.__destructure_map(map__56049);
var data = map__56049__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56049__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56049__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__56050 = data;
var G__56050__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__56050,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__56050);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__56050__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__56050__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__56054 = form;
var G__56054__$1 = (((G__56054 == null))?null:cljs.core.rest(G__56054));
if((G__56054__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__56054__$1);
}
})();
var G__56055 = m;
var G__56055__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__56055,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__56051_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__56051_SHARP_)));
})):G__56055);
var G__56055__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__56055__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__56052_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__56052_SHARP_)));
})):G__56055__$1);
var G__56055__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__56055__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__56053_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__56053_SHARP_));
})):G__56055__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__56055__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__56056 = (function (){var G__56057 = form;
var G__56057__$1 = (((G__56057 == null))?null:cljs.core.rest(G__56057));
if((G__56057__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__56057__$1);
}
})();
var map__56056__$1 = cljs.core.__destructure_map(map__56056);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56056__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56056__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56056__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56056__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__56058 = (function (){var and__5043__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__56062 = form;
var G__56062__$1 = (((G__56062 == null))?null:cljs.core.seq(G__56062));
var G__56062__$2 = (((G__56062__$1 == null))?null:cljs.core.first(G__56062__$1));
if((G__56062__$2 == null)){
return null;
} else {
var fexpr__56063 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__56063.cljs$core$IFn$_invoke$arity$1 ? fexpr__56063.cljs$core$IFn$_invoke$arity$1(G__56062__$2) : fexpr__56063.call(null,G__56062__$2));
}
})():null));
});
/**
...
var len__5769__auto___56081 = arguments.length;
var i__5770__auto___56082 = (0);
while(true){
if((i__5770__auto___56082 < len__5769__auto___56081)){
args__5775__auto__.push((arguments[i__5770__auto___56082]));

var G__56083 = (i__5770__auto___56082 + (1));
i__5770__auto___56082 = G__56083;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq56064){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq56064));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__56065){
var vec__56066 = p__56065;
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__56071){
var map__56072 = p__56071;
var map__56072__$1 = cljs.core.__destructure_map(map__56072);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56072__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56072__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56072__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56072__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__56069_SHARP_){
return cljs.core.map_QMARK_(p1__56069_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__56070_SHARP_){
return cljs.core.contains_QMARK_(p1__56070_SHARP_,x);
});
}),req_keys));
