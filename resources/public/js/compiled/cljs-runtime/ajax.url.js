...
ajax.url.key_value_pair_to_str = (function ajax$url$key_value_pair_to_str(p__47921){
var vec__47923 = p__47921;
...
var vec_key_encode = (function (){var G__47943 = (function (){var or__5045__auto__ = vec_strategy;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47943__$1)].join('')));
 ...
 */
ajax.url.param_to_key_value_pairs = (function ajax$url$param_to_key_value_pairs(vec_key_transform,prefix,p__47963){
var vec__47965 = p__47963;
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47965,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47965,(1),null);
...
(ajax.url.url_request_format.cljs$core$IFn$_invoke$arity$1 = (function (p__48006){
var map__48008 = p__48006;
var map__48008__$1 = cljs.core.__destructure_map(map__48008);
var vec_strategy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48008__$1,new cljs.core.Keyword(null,"vec-strategy","vec-strategy",1843221372));
