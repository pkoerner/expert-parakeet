...
(deftest test-course-iteration-form
  ...
  (testing "Autogenerated tests for course-iteration-form"
    (test-with-check `course-iteration-form opts)))


(deftest test-submit-error-view
  (testing "Autogenerated tests for submit-success-view"
    (test-with-check `submit-error-view opts)))
